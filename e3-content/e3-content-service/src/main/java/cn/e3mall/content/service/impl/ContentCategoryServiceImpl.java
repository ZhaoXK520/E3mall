...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	public E3Result deleteContentCategory(long id) {
		...
		E3Result e3Result = recursiveDelete(id);
		TbContentCategoryExample example = new TbContentCategoryExample();
		Criteria criteria = example.createCriteria();
		criteria.andParentIdEqualTo(parentId);
		if(contentCategoryMapper.countByExample(example)==0){
			...
			newParent.setIsParent(false);
		}
		return e3Result;
	}
	
	E3Result recursiveDelete(long id){
		TbContentCategoryExample example = new TbContentCategoryExample();
		Criteria criteria = example.createCriteria();
	...
	@Override
	public E3Result updateContentCategory(String name, long id) {
		TbContentCategory contentCategory = new TbContentCategory();
